...
| `F2` | Renomear ao vivo — destaca todas as ocorrências exatas da palavra sob o cursor e atualiza o texto conforme você digita (`Enter` confirma, `Esc` cancela, `←`/`→`/`Home`/`End` navegam dentro do nome, `Insert` alterna inserir/sobrescrever) |
