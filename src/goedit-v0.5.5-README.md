...
| Roda do mouse (scroll) | Rola o texto, mantendo o cursor na linha onde o ponteiro está (início da linha) |

O scroll do mouse move o cursor junto, sempre pra linha onde o ponteiro
está (início dela) — não existe rolagem "solta" da tela independente do
cursor neste editor, já que o redesenho sempre mantém o cursor visível.
