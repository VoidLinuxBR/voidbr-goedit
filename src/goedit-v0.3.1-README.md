...
| `F2` | Renomear ao vivo — destaca todas as ocorrências exatas da palavra sob o cursor e atualiza o texto conforme você digita o novo nome (`Enter` confirma, `Esc` cancela) |
